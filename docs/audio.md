...
- `bun test ./scripts/test-fourd-audio.mjs`: schema/anchor rejection, overlap, shared scheduling, source movement, pause/seek/loop/rate cancellation, original fallback, silent clips, and mute persistence using deterministic graph doubles.
